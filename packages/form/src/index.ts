export { default as FormInput } from './form-items/input';
export { default as FormCheckbox } from './form-items/checkbox';
export { default as FormSelect } from './form-items/select';
...
export { default as FormInputNumber } from './form-items/input-number';
